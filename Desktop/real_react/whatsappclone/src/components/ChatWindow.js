...
const ChatWindow = ({user}) => {
    ...
    const [list, setList] = useState([
        {author: 123, body: 'Qualquer cena'}, 
        {author: 123, body: 'Outra cena'}, 
        {author: 123, body: 'Ainda outra'}, 
        {author: 1234, body: 'Looool'},
        {author: 123, body: 'Qualquer cena'}, 
        {author: 123, body: 'Outra cena'}, 
        {author: 123, body: 'Ainda outra'}, 
        {author: 1234, body: 'Looool'},
        ...
        <div className="chatWindow">
            ...
            <div className="chatWindow--header">
                ...
                <div className="chatWindow--headerinfo">
                    ...
                    <div className="chatWindow--name">José Marques</div>
                </div>
